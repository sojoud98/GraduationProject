...
public class ActivityCooking extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    SQLiteDatabase db;
    int hour, minute;
    TextView timeSel, num_people;
    private DatePickerDialog datePickerDialog;
    private Button dateButton, makeOrderBtn;
    EditText number_input, foodTypeInput;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking);
        foodTypeInput =findViewById(R.id.typeFood);
        ...
        num_people = findViewById(R.id.people_number);
        number_input = findViewById(R.id.people_number_input);
        ...
        makeOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (done) {
                    ...
                    Toast.makeText(ActivityCooking.this, "Failed, please try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(ActivityCooking.this, ActivityHome.class));

                break;
            case R.id.nav_profile:

                startActivity(new Intent(ActivityCooking.this, Activity_profile.class));

                break;
            case R.id.nav_logout:
                firebaseAuth.signOut();
                startActivity(new Intent(ActivityCooking.this, MainActivity.class));
    ...
    public boolean addRequest() {
        ...
        contentVals.put("service", "cooking");
        contentVals.put("info", "People: " + number_input.getText().toString() + " \nFood: " + foodTypeInput.getText().toString());
